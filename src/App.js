...
function App() {
  ...
  return (
    <div className="container">
      ...
      <label className="px-1">New item</label>
      ...
      <table>
        ...
        {items.map(item => (
          <tr key={item.id}>
            ...
            <td className="text-center item_box">
            {editItem?.id !==  item.id &&
            item.description
            }
            {editItem?.id === item.id && 
            ...
            <td className="text-center amount_box">
            {editItem?.id !==  item.id &&
            item.amount
            }
